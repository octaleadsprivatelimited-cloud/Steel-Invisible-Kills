        ...
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-2 sm:py-3">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3 flex-shrink-0">
              {/* WhatsApp Button */}
              <a
                href="https://wa.me/919912373373?text=Hi! I would like to get a quote for invisible grills installation. Please provide me with more information."
                target="_blank"
              ...
              {/* Phone Number */}
              <a href="tel:+919912373373" className="text-white hover:text-yellow-400 transition-colors text-xs sm:text-sm lg:text-base flex items-center whitespace-nowrap flex-shrink-0">
                <Phone className="h-3 w-3 sm:h-4 sm:w-4 lg:h-4 lg:w-4 mr-1 flex-shrink-0" />
                <span className="hidden lg:inline">+91 9912373373</span>
                <span className="hidden sm:inline lg:hidden">+91 9912373373</span>
                <span className="sm:hidden">+91 9912373373</span>
              </a>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/20 shadow-2xl">
                ...
                <div className="mt-3 sm:mt-4 text-center">
                  <p className="text-gray-300 text-xs">
                    Or call us directly: 
                    <a href="tel:+919912373373" className="text-yellow-400 font-semibold ml-1">
                      +91 9912373373
                    </a>
                  </p>
                </div>
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="mt-4 text-center">
                  <p className="text-gray-500 text-xs sm:text-sm">
                    Or call us directly: 
                    <a href="tel:+919912373373" className="text-yellow-600 font-semibold ml-1">
                      +91 9912373373
                    </a>
                  </p>
                </div>
